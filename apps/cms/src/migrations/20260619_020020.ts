...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_projects_blocks_quote_content_layout" AS ENUM('small', 'medium');
  CREATE TYPE "public"."enum_projects_blocks_link_content_layout" AS ENUM('left', 'right', 'center');
  ...
  CREATE TABLE "media" (
  	...
  	"ratio" "enum_media_ratio" NOT NULL,
  	"caption" varchar,
  ...
  CREATE TABLE "projects_blocks_link" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "projects_blocks_media_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"name" varchar,
  	"type" "enum_projects_blocks_media_content_type" NOT NULL,
  	"block_name" varchar
  );
  
  CREATE TABLE "projects_blocks_quote_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	...
  	"text" jsonb NOT NULL,
  	"layout" "enum_projects_blocks_quote_content_layout" DEFAULT 'small' NOT NULL,
  	"block_name" varchar
  );
  
  CREATE TABLE "projects_blocks_link_content" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar DEFAULT 'See it live' NOT NULL,
  	"name" varchar NOT NULL,
  	"url" varchar NOT NULL,
  	"layout" "enum_projects_blocks_link_content_layout" DEFAULT 'center' NOT NULL,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "projects_blocks_media_content" ADD CONSTRAINT "projects_blocks_media_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "projects_blocks_quote_content" ADD CONSTRAINT "projects_blocks_quote_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "projects_blocks_link_content" ADD CONSTRAINT "projects_blocks_link_content_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "projects_blocks_media_content_order_idx" ON "projects_blocks_media_content" USING btree ("_order");
  CREATE INDEX "projects_blocks_media_content_parent_id_idx" ON "projects_blocks_media_content" USING btree ("_parent_id");
  CREATE INDEX "projects_blocks_media_content_path_idx" ON "projects_blocks_media_content" USING btree ("_path");
  CREATE INDEX "projects_blocks_quote_content_order_idx" ON "projects_blocks_quote_content" USING btree ("_order");
  CREATE INDEX "projects_blocks_quote_content_parent_id_idx" ON "projects_blocks_quote_content" USING btree ("_parent_id");
  CREATE INDEX "projects_blocks_quote_content_path_idx" ON "projects_blocks_quote_content" USING btree ("_path");
  CREATE INDEX "projects_blocks_link_content_order_idx" ON "projects_blocks_link_content" USING btree ("_order");
  CREATE INDEX "projects_blocks_link_content_parent_id_idx" ON "projects_blocks_link_content" USING btree ("_parent_id");
  CREATE INDEX "projects_blocks_link_content_path_idx" ON "projects_blocks_link_content" USING btree ("_path");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "projects_blocks_link" CASCADE;
  DROP TABLE "projects_blocks_label" CASCADE;
  DROP TABLE "projects_blocks_media_content" CASCADE;
  DROP TABLE "projects_blocks_quote_content" CASCADE;
  DROP TABLE "projects_blocks_link_content" CASCADE;
  ...
  DROP TYPE "public"."enum_projects_blocks_quote_content_layout";
  DROP TYPE "public"."enum_projects_blocks_link_content_layout";`)
}
